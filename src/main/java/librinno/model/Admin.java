...
public class Admin extends User {
    ...
    public Admin(String name, String address, String number, int cardnumber, String type, String password, String email, String privilege) {
        super(name, address, number, cardnumber, type, password, email, privilege);
    }
    public Admin(){}
