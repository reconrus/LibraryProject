...
public class Test {
    ...
    static void test_1() throws SQLException {
        defaultTable();
    ...
    static void test_3() throws SQLException{
        defaultTable();
    ...
    static void test_4() throws SQLException{
        defaultTable();
        ...
        Booking booking=new Booking();
        if(booking.check_out(2,1)) System.out.println("Shilov tries to check out War And Peace  \nChecking out was successful \n\n");
    ...
    static void test_7() throws SQLException{
        defaultTable();
        ...
        if(booking.check_out(1,3)) System.out.println("Ilnur tries to check out Touch of Class  \nChecking out was successful \n\n");
        printBooks();

        System.out.println("\n");
    }

    static void test_8() throws SQLException{
        defaultTable();
    ...
    static void test_9() throws SQLException{
        defaultTable();
        ...
        Booking booking=new Booking();
        if(booking.check_out(1,1)) System.out.println("Ilnur tries to check out War And Peace  \nChecking out was successful \n\n");
